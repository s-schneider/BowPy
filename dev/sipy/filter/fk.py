...
def pocs_recon(st, maxiter, method='denoise', dmethod='linear', alpha=0.9, beta=None, peaks=None, maskshape=None):
	"""
	This functions reconstructs missing signals in the f-k domain, using the original data,
	...
	ADfinal = pocs(ArrayData, maxiter, noft, alpha, beta,  dmethod, peaks, maskshape)
