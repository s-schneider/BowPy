...
def pocs_recon(st, maxiter, method='denoise', decrease='linear', alpha=0.9, peaks=None, maskshape=None):
	"""
	This functions reconstructs missing signals in the f-k domain, using the original data,
	...
	ADfinal = pocs(ArrayData, maxiter, noft, alpha, decrease, peaks, maskshape)
