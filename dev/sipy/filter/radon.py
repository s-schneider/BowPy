...
def radon_inverse(t,epi,M,p,weights,ref_dist,line_model,inversion_model,hyperparameters):
	"""
	This function inverts move-out data to the Radon domain given the inputs:
	 -t        -- vector of time axis.
	 -epi    -- vector of distance axis.
	...
	if not isinstance(t, numpy.ndarray) or not isinstance(epi, numpy.ndarray):
		print( "Wrong input type of t or epi, must be numpy.ndarray" )
		raise TypeError
