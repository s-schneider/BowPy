...
def makeMask(fkdata, slope, shape, rth=0.4):
	"""
	...
	Wlhs = np.roll(Wr[:,0:149], shift=1, axis=0)
	Wrhs = Wr[:,1:151]
...
def pocs(data, maxiter, noft, alpha=0.9, decrease='linear'):
	"""
