...
def create_quake_origins(time=None, lat=None, lon=None, depth_in_m=None, m_rr=None, m_tt=None, m_pp=None, m_rt=None, m_rp=None, m_tp=None, event=None):
	...
	# If event file is input, creating of quake_origins starts with from this input, other inputs will be ignored!
	if event:
		time 	= event.origins.time
		lat 	= event.origins.latitude
		lon 	= event.origins.longitude
		depth_in_m = event.origins.depth
